					...
					<table class="layui-table admin-table">
						...
						<%
			             ...
			             %>
			                ...
			                <td>
			                <form name="return_borrowCR" action="../servlet/servBorrow_ReturnCR" method="post">
			             ...
			             <%
			                	if(status==1){
			             %>	
			             	<input type="hidden" name="status" value=<%= status%> style="border:0;"size="2" readonly>
			             	<td>空闲</td>
			                <td><button name="borrowCR" class="layui-btn layui-btn-small">
			                	借出<input type="submit" value="" style="BACKGROUND-COLOR: transparent;border:0"></button>
			                </td></form>
			             ...
			             %>	
			             	<input type="hidden" name="status" value=<%= status%> style="border:0;"size="2" readonly>
			             	<td>使用中</td>
			                <td><button name="returnCR"  class="layui-btn layui-btn-small">
			                	归还<input type="submit"  value="" style="BACKGROUND-COLOR: transparent;border:0"></button>
			                </td></form>
			             <%
			               		}  
			             %>     
